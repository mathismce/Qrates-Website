    ...
    <div className="overflow-clip">
      ...
      <div>
        <div className="flex flex-col items-center justify-items-center h-full bg-black p-8 gap-4 text-white 2xl:px-52 2xl:py-24 py-24 pb-36">
          <div className="flex gap-16 z-10 p-6  max-w-full">
            ...
            <Image
              className="rotate-12 w-[500px] mt-[20px] border-2 border-black z-0"
      ...
      <div className="bg-gray" >
        <h4 className="py-24 text-center text-4xl font-bold ">Choose from two formats with promised quality</h4>
        <div className="flex flex-col sm:flex-row">
          <div className="flex flex-col items-center gap-8 border-t border-b border-black border-2 p-16">
            <h5 className="text-4xl font-bold">Vinyl</h5>
            <p className="text-center text-lg font-semibold">We know how special pressed records are to you. Our products are built for fans, by fans. We make it easy for artists to press vinyl, so the music you love can keep reaching ears in the most beautiful way.</p>
            <Image
              className="w-[800px]"
              src="/vinyl.avif"
              alt="Vinyl"
          ...
          <div className="flex flex-col items-center gap-8 border-t border-b border-2 border-black p-16" >
            <h5 className="text-4xl font-bold" >Cassette</h5>
            <p className="text-center text-lg font-semibold">Cassettes have always been special to music fans and artists. Whether you are saving a recording of a great concert, or preserving an early demo, there’s no better way to keep that music close than on cassette tapes.</p>
            <Image
              className="w-[800px]"
              src="/cassette.avif"
              alt="Cassettes"
      ...
      <div className="bg-black" >
        <h4 className="py-24 text-white text-center text-6xl font-bold">You make music. We do the rest.</h4>
      </div>
